document.addEventListener("DOMContentLoaded", () => {
  ...
  const defaultResources = [
    ...
    { title: "Fire Suppression", type: "Video", link: "https://youtu.be/tXpmfkneLJg" },
    { title: "Basic Life Support (BLS)", type: "Video", link: "https://youtu.be/n7kqiAu2gC8" },
    { title: "First Aid", type: "Video", link: "https://youtu.be/AhANvBB9hz0" },
    { title: "Water Survival", type: "Video", link: "https://www.youtube.com/shorts/CVXtNFkwxWg" }
  ];
  ...
  const defaultEvents = [
    ...
    { title: "Basic First Aid Training", location: "Manila City Hall", date: "2025-05-03" },
    { title: "CPR and AED Workshop", location: "Quezon City Medical Center", date: "2025-05-10" },
    { title: "Disaster Response Seminar", location: "UP Diliman, Quezon City", date: "2025-05-15" },
    { title: "Fire Safety Drill", location: "Makati Central Fire Station", date: "2025-05-20" }
  ];
